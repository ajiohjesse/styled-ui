...
export const darkModeColors: Colors = {
  background: '222.2, 14%, 8%',
  foreground: '222.2, 84%, 90%',

  card: '0, 0%, 15%',
  card_foreground: '222.2, 84%, 80%',

  popover: '0, 0%, 15%',
  popover_foreground: '222.2, 84%, 80%',

  primary: '218, 96%, 57%',
  primary_foreground: '210, 40%, 98%',

  secondary: '210, 30%, 20%',
  secondary_foreground: '222.2, 47.4%, 80%',

  muted: '210, 40%, 20%',
  muted_foreground: '215.4, 16.3%, 80%',

  accent: '210, 40%, 20%',
  accent_foreground: '222.2, 47.4%, 80%',

  destructive: '0, 54.2%, 44%',
  destructive_foreground: '210, 70%, 98%',
